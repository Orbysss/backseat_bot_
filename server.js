            ...
            if (tokens[0] == "!bs" && tokens[1] == "rating" && tokens.length == 4) {
                axios.get(`https://api.chess.com/pub/player/${tokens[3]}/stats`).then(res => {
                    ...
                    if (tokens[2] == "bullet" && res.data.chess_bullet) {
                        ...
                        client.action(channel.slice(1,channel.length), '[3] (Bullet) Current:' + bulletRank + ' | Best: ' + bulletPeak)
                        ...
                        client.action(channel.slice(1,channel.length), '[3] (Blitz) Current:' + blitzRank + ' | Best: ' + blitzPeak)
                        ...
                        client.action(channel.slice(1,channel.length), '[3] (Bullet) Current:' + rapidRank + ' | Best: ' + rapidPeak)
                    } else {
